...
namespace MultipleInheritance2
{
    public class ShiftDezire : Car, IBrand
    {
        ...
        public ShiftDezire(string fuleType, int numberOfSeats, string color, double tankCapacity, double numberOfKmDriven, string engineNumber, string chasisNumber, string brandName, string modelName) : base(fuleType, numberOfSeats, color, tankCapacity, numberOfKmDriven)
        {
            s_makingID++;
